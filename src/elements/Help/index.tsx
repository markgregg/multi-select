...
const Help: React.FC<HelpProps> = ({ theme }) => {
  ...
  const [helpPage, setHelpPage] = React.useState<'operators' | 'keybord'>(
    'operators',
  )
  ...
  return (
    <div ref={divRef} className="helpIcon">
      <TbHelpSquareRoundedFilled onClick={toggleHelp} />
      {showHelp && (
        <div className="helpInstructions" style={bodyStyleFromTheme(theme)}>
          ...
          {helpPage === 'operators' && (
            <div className="helpInstructionsText">
